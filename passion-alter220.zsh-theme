...
# time
function real_time() {
    local color="%{[38;5;220m%}";                    # color in PROMPT need format in %{XXX%} which is not same with echo
...
# git
ZSH_THEME_GIT_PROMPT_PREFIX="%{[38;5;220m%}[";
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$reset_color%} ";
ZSH_THEME_GIT_PROMPT_DIRTY=" %{$fg_no_bold[red]%}✖%{[38;5;220m%}]";
ZSH_THEME_GIT_PROMPT_CLEAN="%{[38;5;220m%}]";

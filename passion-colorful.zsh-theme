...
# time
function real_time() {
    local color="%{[38;5;${COLOR_CODE}m%}";                    # color in PROMPT need format in %{XXX%} which is not same with echo
...
# git
ZSH_THEME_GIT_PROMPT_PREFIX="%{[38;5;${COLOR_CODE}m%}[";
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$reset_color%} ";
ZSH_THEME_GIT_PROMPT_DIRTY=" %{$fg_no_bold[red]%}✖%{[38;5;${COLOR_CODE}m%}]";
ZSH_THEME_GIT_PROMPT_CLEAN="%{[38;5;${COLOR_CODE}m%}]";
...
output_command_execute_after() {
    ...
    # time
    local time="[$(date +%H:%M:%S)]"
    local color_time="[38;5;${COLOR_CODE}m";
    ...
    # According .oh-my-zsh/lib/spectrum.zsh line 17 to 20
    # >>> for color in {000..255}; do
    # >>>   FG[$color]="%{[38;5;${color}m%}"
    # >>>   BG[$color]="%{[48;5;${color}m%}"
    # >>> done
    # It is the syntax making other color available

    local color_cost="[38;5;${COLOR_CODE}m";
